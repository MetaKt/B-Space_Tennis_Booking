...
const resources = {
  en: {
    translation: {
      ...
      provisional: {
        reserved: 'RESERVED',
        expiresIn: 'Reservation expires in {{time}} — complete payment to confirm.',
        release: 'Release',
        continue: 'Continue →',
        released: 'Reservation released',
        releaseFailed: 'Failed to release reservation',
        pendingTitle: 'You have a pending reservation',
        pendingBody: 'Your reservation for Court {{court}} at {{start}}–{{end}} expires in',
        logoutWarning: 'If you log out now, the reservation will be cancelled and the slot released to other users.',
        stayLoggedIn: 'Stay logged in',
        cancelAndLogout: 'Cancel & log out',
        swapTitle: 'Release current reservation?',
        swapBody: 'You have a reservation for {{start}}–{{end}} on the {{date}}.',
        swapNote: 'Continuing will release it and reserve your new selection. A fresh 15-minute timer will start.',
      ...
      booking: {
        ...
        outsideCoachLabel: 'Outside Coach',
        addOns: 'Add-ons',
  ...
  th: {
    translation: {
      ...
      provisional: {
        reserved: 'จองไว้',
        expiresIn: 'การจองจะหมดเวลาใน {{time}} — กรุณาชำระเงินเพื่อยืนยัน',
        release: 'ยกเลิกการจอง',
        continue: 'ดำเนินการต่อ →',
        released: 'ยกเลิกการจองแล้ว',
        releaseFailed: 'ไม่สามารถยกเลิกการจองได้',
        pendingTitle: 'คุณมีการจองที่ยังไม่เสร็จสิ้น',
        pendingBody: 'การจองสนาม {{court}} เวลา {{start}}–{{end}} จะหมดเวลาใน',
        logoutWarning: 'หากออกจากระบบตอนนี้ การจองจะถูกยกเลิกและสนามจะถูกปล่อยให้ผู้อื่นจอง',
        stayLoggedIn: 'อยู่ในระบบต่อ',
        cancelAndLogout: 'ยกเลิกและออกจากระบบ',
        swapTitle: 'ยกเลิกการจองปัจจุบันหรือไม่?',
        swapBody: 'คุณมีการจองเวลา {{start}}–{{end}} วันที่ {{date}}',
        swapNote: 'การดำเนินการต่อจะยกเลิกการจองเดิมและจองช่วงเวลาใหม่ที่เลือก โดยเริ่มนับเวลา 15 นาทีใหม่',
